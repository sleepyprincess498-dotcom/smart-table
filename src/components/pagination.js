...
export const initPagination = ({pages, fromRow, toRow, totalRows}, createPage) => {
    ...
    return (data, state, action) => {
        ...
        const startIndex = (page - 1) * rowsPerPage;                     // индекс первого элемента на странице
        const pageData = data.slice(startIndex, startIndex + rowsPerPage);         // данные для текущей страницы 
